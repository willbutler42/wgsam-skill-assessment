...
figName <- "ldist_cod_survQ2.ps"
  tmp$ldist.cod.surQ2 +
  labs(subtitle=figName) +
  ggRunName() + ggRunNameSize(6)
  ggsave(paste(dirFigs,figName, sep="/"), device="ps")

figName <- "ldist_cod_survQ4.ps"
  tmp$ldist.cod.surQ4 +
  labs(subtitle=figName) +
  ggRunName() + ggRunNameSize(6)
ggsave(paste(dirFigs,figName, sep="/"), device="ps")

figName <- "alk_cod_survQ2.ps"
  tmp$alk.cod.surQ2 +
  labs(subtitle=figName) +
  ggRunName() + ggRunNameSize(6)
ggsave(paste(dirFigs,figName, sep="/"), device="ps")

figName <- "alk_cod_survQ4.ps"
  tmp$alk.cod.surQ4 +
  labs(subtitle=figName) +
  ggRunName() + ggRunNameSize(6)
ggsave(paste(dirFigs,figName, sep="/"), device="ps")
...
## figName <- "adist_cod_survQ2.ps"
##   tmp$adist.cod.surQ2 +
##   labs(subtitle=figName) +
##   ggRunName() + ggRunNameSize(6)
## ggsave(paste(dirFigs,figName, sep="/"), device="ps")

## figName <- "adist_cod_survQ4.ps"
##   tmp$adist.cod.surQ4 +
##   labs(subtitle=figName) +
##   ggRunName() + ggRunNameSize(6)
## ggsave(paste(dirFigs,figName, sep="/"), device="ps")
...
figName <- "growth_cod_survQ2.ps"
  grplot$alk.cod.surQ2 +
  labs(subtitle=figName) +
  ggRunName() + ggRunNameSize(6)
ggsave(paste(dirFigs,figName, sep="/"), device="ps")

figName <- "growth_cod_survQ4.ps"
  grplot$alk.cod.surQ4 +
  labs(subtitle=figName) +
  ggRunName() + ggRunNameSize(6)
ggsave(paste(dirFigs,figName, sep="/"), device="ps")
...
ggLenDist(Gfit=fitL, compName="ldist.cod.surQ2", yrs=50:60)
ggLenDist(Gfit=fitL, compName="ldist.cod.surQ4", yrs=50:60)
ggAgeDist(Gfit=fitL, compName="adist.cod.com", yrs=50:60)
ggAgeDist(Gfit=fitL, compName="adist.cod.surQ2", yrs=50:60)
ggAgeDist(Gfit=fitL, compName="adist.cod.surQ4", yrs=50:60)
